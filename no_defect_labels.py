# CREATING EMPTY LABELS FOR NO DEFECT FISH PEN NET DATASET
...
DATASET_DIR = r"C:\Users\ANTONETTE\thesis_yolo\test_cleaned"
OUTPUT_DIR = r"C:\Users\ANTONETTE\thesis_yolo\test2_labeled"
...
# Lower = stricter, removes only very similar images
...
print("=" * 80)
print("RAW FRAME PERCEPTUAL HASH CLEANING WITH EMPTY LABELS FOR NO_DEFECT")
print("=" * 80)
...
for source in SOURCE_FOLDERS:
    ...
    for filename in image_files:
        ...
        if source == "no_defect":
            ...
            output_label_path = os.path.join(output_image_dir, label_filename)
...
print("[INFO] Empty label .txt files generated alongside images inside the 'no_defect' folder.")
